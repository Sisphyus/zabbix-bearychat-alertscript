...
url='https://hook.bearychat.com/=bwAup/zabbix/ef14932605c31adfa1ab2e91b9469a0e'		# example: https://hook.bearychat.com/XXX/zabbix/XXXXXXXXXXXXXXXXXXXXXXX
...
payload="payload={\"channel\": \"${to//\"/\\\"}\", \"attachments\": [{\"text\": \"${message//\"/\\\"}\", \"color\": \"${color}\"}]}"
